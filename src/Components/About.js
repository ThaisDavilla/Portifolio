...
import Working from "../Images/trabalhando.png";
      ...
      <section>
        ...
        <S.DivThree>
          <S.Paragraph>Como profissional se fosse me resumir em uma única palavra seria
            com a palavra compromisso, porque estou sempre atenta e disposta
          ...
          <S.Img src={Working} alt="Imagem de livros, um diploma e um capelo." />
        </S.DivThree>
        <S.DivFour>
        <S.Img src={Student} alt="Imagem de livros, um diploma e um capelo." />
