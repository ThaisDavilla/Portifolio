...
export default function About(){
  return(
    <>
      <h1>About Me</h1>
      <section>
        <p>No momento estou cursando o primeiro semestre de Engenharia da 
        ...
        <p>Desde março de 2022, através do curso técnico Vai na Web, aprendi 
          ...
          apreciados além das hardskills.</p>
          <p>Como profissional se fosse me resumir em uma única palavra seria
          ...
          <p>Sou organizada, proativa, muito comunicativa, acolhedora e boa ouvinte.
            Gosto muito de fazer amizades, de ver um bom filme, ler livros, ouvir 
            música boa, passear, viajar e de comer.
            Meus objetivos a curto prazo são chegar ao nível intermediaário da língua
            inglesa e ser desenvolvedora FullStack.
            Estou a disposição caso queira me conhecer melhor! Pode me contatar
            seja para uma conversa informal ou para uma entrevista para uma 
            oportunidade de colaborar com a sua equipe.
           </p>
      </section>
    </>
  )
